    ...
    <div className="min-h-screen bg-background">
      <header className="border-b sticky top-0 z-40 bg-background/95 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 bg-clip-text text-transparent">GeoLink</span>
          </div>
      ...
      <section className="max-w-3xl mx-auto px-4 pt-16 pb-12 text-center">
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            <Image src="/images/geolink-logo.png" alt="GeoLink" width={100} height={100} className="relative rounded-3xl shadow-2xl" />
          </div>
        </div>

        <h1 className="text-4xl sm:text-6xl font-extrabold mb-5 tracking-tight">
          Connect With The{' '}
          <span className="bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 bg-clip-text text-transparent">World</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/signup">
            <Button size="lg" className="px-10 w-full sm:w-auto h-12 text-base font-semibold bg-gradient-to-r from-pink-500 to-purple-500 text-white border-0">
              Get Started Free
            </Button>
          </Link>
          <Link href="/login">
            <Button size="lg" variant="outline" className="w-full sm:w-auto h-12 text-base">Log In</Button>
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 py-14 border-t">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            { icon: MessageCircle, title: 'Real-time Chat', desc: 'Instant messaging with online status.' },
            { icon: Users, title: 'Follow System', desc: 'Follow friends or keep account private.' },
            { icon: Film, title: 'Reels', desc: 'Short videos in TikTok-style feed.' },
            { icon: Zap, title: 'Live Feed', desc: 'Posts from people you follow, live.' },
